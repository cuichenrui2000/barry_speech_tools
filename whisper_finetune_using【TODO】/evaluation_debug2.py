...
add_arg("test_data",   type=str, default="/nfs/volume-225-14/laizhihao_i/data/train_data/valid_all.json",            help="测试集的路径")
add_arg("model_path",  type=str, default="/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/output_3000/model_large_v2-finetune", help="合并模型的路径，或者是huggingface上模型的名称")
