...
add_arg("test_data",   type=str, default="/nfs/volume-225-14/laizhihao_i/data/train_data_small/test/test_general_finetune_new.json",            help="测试集的路径")
add_arg("model_path",  type=str, default="/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/train_small_data/model_medium/models/model_medium-finetune", help="合并模型的路径，或者是huggingface上模型的名称")
add_arg("batch_size",  type=int, default=48,        help="评估的batch size")
...
# 获取评估方法
metric = evaluate.load(f'/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/metrics/{args.metric}.py')

# 开始评估
hyp_path = "/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/train_small_data/model_medium/result/hyp_general_new"
lab_path = "/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/train_small_data/model_medium/result/lab_general_new"
