...
bash run_finetune_2wh_lr_cuichenrui_02.sh > /nfs/volume-225-14/cuichenrui/whisper/whisper_medium_full_finetune/medium_2w_data_fp32_1e-5lr/rank1/finetune.log 2>&1
