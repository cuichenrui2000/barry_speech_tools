...
add_arg("hyp_path",   type=str, default="/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/2w_data/model_medium/result/hyp_general_opensource",            help="测试结果文件路径")
add_arg("lab_path",   type=str, default="/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/2w_data/model_medium/result/lab_general_opensource",            help="测试结果答案路径")
add_arg("test_data",   type=str, default="/nfs/volume-225-14/laizhihao_i/data/testset_all/General/general_opensource.jsonl",            help="测试集的路径")
...
add_arg("batch_size",  type=int, default=1,        help="评估的batch size")
...
# # 开始评估
# hyp_path = "/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/2w_data/model_medium/result/hyp_general_opensource"
# lab_path = "/nfs/volume-225-14/laizhihao_i/Whisper/Whisper-Finetune/checkpoint/2w_data/model_medium/result/lab_general_opensource"
    ...
    for step, batch in enumerate(tqdm(eval_dataloader)):
        with torch.cuda.amp.autocast():
            with torch.no_grad():
                ...
                # 去除标签和识别结果中的空格
                # decoded_preds = [string.replace(" ", "") for string in decoded_preds]
                # decoded_labels = [string.replace(" ", "") for string in decoded_labels]
