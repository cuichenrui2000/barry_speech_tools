...
# 示例为dynamic场景，其他场景以此类推

data_list_filenames = ["dynamic1_scene1/wav.ref",
                    "dynamic1_scene2/wav.ref",
                    "dynamic1_scene3/wav.ref",
                    "dynamic1_scene4/wav.ref",
                    "dynamic1_scene5/wav.ref",
                    "dynamic1_scene6/wav.ref",
                    "dynamic2_scene1/wav.ref",
                    "dynamic2_scene2/wav.ref",
                    "dynamic2_scene3/wav.ref",
                    "dynamic2_scene4/wav.ref"]

whisper_json_filename = "dynamic.json"
...
for data_list_filename in data_list_filenames:
    ...
    with open(data_list_filename, "r", encoding='gb18030') as data_list_file:
